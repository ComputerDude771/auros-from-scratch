/* layouts/workbench.c — the "workbench" archetype. STUB: replace with a real renderer.
 *
 * Exists so that partial builds always link while the six archetypes are
 * developed independently. See shells/workbench.shell for the interaction model
